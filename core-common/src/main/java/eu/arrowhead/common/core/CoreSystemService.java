...
public enum CoreSystemService {
	...
	SERVICEINVENTORY_AI_LABELING_SERVICE(CommonConstants.CORE_SERVICE_SERVICEINVENTORY_AI_LABELING, CommonConstants.SERVICEINVENTORY_URI + CommonConstants.OP_SERVICEINVENTORY_AI_LABELING_URI, List.of(new InterfaceData(CommonConstants.HTTP, CommonConstants.TEXT))),
	SERVICEINVENTORY_AI_LABELING_RESULTS_SERVICE(CommonConstants.CORE_SERVICE_SERVICEINVENTORY_AI_LABELING_RESULTS, CommonConstants.SERVICEINVENTORY_URI + CommonConstants.OP_SERVICEINVENTORY_AI_LABELING_RESULTS_URI);
