...
public enum CoreSystemService {
	...
	SERVICEINVENTORY_AI_LABELING_SERVICE(CommonConstants.CORE_SERVICE_SERVICEINVENTORY_AI_LABELING, CommonConstants.SERVICEINVENTORY_URI + CommonConstants.OP_SERVICEINVENTORY_AI_LABELING_URI),
